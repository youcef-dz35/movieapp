    ...
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24 ">
                ...
                <div class="mt-2 flex flex-wrap items-center text-gray-400 text-sm">
                ...
                <div class="mt-12">
                    <h4 class="text-white font-semibold">Featured Crew /Actors</h4>
                    <div class="flex mt-4">
                                ...
                                <div class="mr-8">
                                    ...
                                    @if ($crew['profile_path'])
                                        <a href="{{route('actors.show', $crew['id'])}}">
                                            <img src="https://images.tmdb.org/t/p/w92/{{$crew['profile_path']}}"  alt="poster">
                                        </a>
                                        @else
                                        <a href="{{route('actors.show', $crew['id'])}}">
                                            <img src="https://dummyimage.com/92x138/999199/fff&text={{ $crew['job'] }}" alt="poster" >
                                        </a>
                                    @endif
                        ...
                        @foreach ($tvshow['cast1'] as $cast)

                            <div class="mr-8">
                                <div>
                                @if ($cast['profile_path'])
                                <a href="{{route('actors.show', $cast['id'])}}">
                                    <img src="https://images.tmdb.org/t/p/w92/{{$cast['profile_path']}}" alt="poster">
                                </a>
                                @else
                                <a href="{{route('actors.show', $cast['id'])}}">
                                    <img src="https://dummyimage.com/92x138/999199/fff&text={{ $cast['known_for_department'] }}" alt="poster" >
                                </a>
                                @endif
                                    {{ $cast['name'] }}
                                </div>
                ...
                <div x-data="{ isOpen: false }">
                    @if (count($tvshow['videos']['results']) > 0)
                        <div class="mt-12">
                            <button
                                @click="isOpen = true"
                                class="inline-flex items-center bg-yellow-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150"
                            >
